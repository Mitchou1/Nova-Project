...
def _merge(defaults, loaded):
    """Fusion récursive : les clés manquantes reprennent la valeur par défaut."""
...
class ConfigLoader:
    """Charge, expose et sauvegarde la configuration système."""
...
def get_config():
    """Singleton paresseux (évite tout effet de bord à l'import)."""
    global _instance
